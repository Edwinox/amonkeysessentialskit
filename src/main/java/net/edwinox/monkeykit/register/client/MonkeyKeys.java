package net.edwinox.monkeykit.register.client;
...
import static net.edwinox.monkeykit.MonkeyKit.NAME;

@SuppressWarnings("unused")
@EventBusSubscriber(modid = MOD_ID, value = Dist.CLIENT)
public enum MonkeyKeys {
    DRILL_ACTIVATION("drill_active", GLFW.GLFW_KEY_LEFT_ALT, "Active Drill Action")
    ;
    ...
    MonkeyKeys(int defaultKey) {
        this("", defaultKey, "");
    }
    MonkeyKeys(String description, int defaultKey, String translation) {
